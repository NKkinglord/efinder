ROSTER_DISCOVERY_SCHEMA = {
    ...
    "properties": {
        ...
        "roster_status": {"type": "string", "enum": ["completed", "incomplete"]},
...
SCHOOL_RESULT_SCHEMA = {
    ...
    "properties": {
        "school_name": {"type": "string"},
        "roster_source": {"type": "string"},
        "school_status": {"type": "string", "enum": ["completed", "incomplete"]},
        ...
        "faculty_classifications": {
            ...
            "items": {
                ...
                "required": [
                    "candidate_name", "discipline", "current_rank", "decision",
                    "exclusion_or_review_reason", "phd_year", "first_year_of_rank",
                    "first_year_basis", "profile_or_cv_url", "current_source",
    ...
    "required": [
        "school_name", "roster_source", "school_status", "school_note",
        "faculty_classifications",
    ],
    "additionalProperties": False,
}
    ...
    "properties": {
        ...
        "supplemental_records": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "first_year_basis": {
                        ...
                        "enum": [
                            "exact_promotion_appointment",
                            "joined_school_at_rank",
                            "earliest_personal_cv_title_year",
                            "school_start_fallback",
                            "unknown",
                        ],
                    },
                ...
                "required": [
                    "candidate_name", "phd_year", "first_year_of_rank",
                    "first_year_basis", "cv_url", "evidence_urls", "notes",
                ],
                "additionalProperties": False,
            },
        },
    },
    "required": ["school_name", "supplemental_records"],
    "additionalProperties": False,
}
